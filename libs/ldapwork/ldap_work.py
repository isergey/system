...
from libs.ldapwork.ldapuser import LdapUser , user_attr_map, user_get_fields
from libs.ldapwork.ldaporganisation import LdapOrganisation, org_attr_map, org_get_fields
