...
class MARCReader(Reader):
    ...
    def __init__(self, marc_target, to_unicode=True, force_utf8=False, encoding='utf-8',
        ...
        elif isinstance(marc_target, list) or isinstance(marc_target, tuple):
            self.file_handle = StringIO(''.join(marc_target))
        else:
