...
class MenuItem(models.Model):
    ...
    caption = models.CharField(ugettext_lazy('caption'), max_length=256)
    url = models.CharField(ugettext_lazy('URL'), max_length=256, blank=True)
    named_url = models.CharField(ugettext_lazy('named URL'), max_length=256, blank=True)
