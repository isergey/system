...
def checkout(request):
    ...
    prolongations = UserProlongation.objects.select_related().filter(recive_library__in=libraries_ids).order_by('-create_date')
...
def checkout_by_library(request, id):
    ...
    prolongations = UserProlongation.objects.select_related().filter(recive_library=library).order_by('-create_date')
